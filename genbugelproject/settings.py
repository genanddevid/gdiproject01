...
MIDDLEWARE = [
    ...
    'genbugelproject.middleware.MobileOnlyMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'authy.context_processors.unread_notifications_count',
                'authy.context_processors.is_mobile_device',
            ],
        },
    },
]
