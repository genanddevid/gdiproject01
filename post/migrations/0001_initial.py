    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(default='defaults/default.jpg', upload_to=post.models.user_directory_path, verbose_name='Picture')),
                ('caption', models.TextField(default='Default caption text', max_length=1500, verbose_name='Caption')),
